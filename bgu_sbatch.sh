...
python main.py --frequency_path=/home/reemha/Privacy-Playground/wiki_freq_roberta.pkl --remap=validation --save=stencil_sst2_val.pt --remap_type=conv --frequency_window=half --dataset=sst2  #--finetune
